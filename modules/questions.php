...
<html>
	...
	<li><a rel="external" href="http://www.sovedyr.dk/Gymnalyse/">Forside</a></li>
			...
			<div id="core" class="clearfix">
                                <section id="left">
					<h1> Sp&oslash;rgeskema</h1>
					<p>Herunder f&oslash;lger der 22 udsagn. Du skal vurdere hver enkelt udsagn på en skala fra 1 til 10. Hvor 10 betyder <em>Helt enig</em> og 1 betyder <em>Helt uenig</em>.<br><br>
					<form action="calc.php" name="Questions" method="post">
					<p>V&aelig;lg din skole:<br>
						<select name="Skole">
							...
							<option value="MG"selected>Marselisborg Gymnasium</option>
						</select></p><br> 		
				
					<p>V&aelig;lg din klasse:<br>
						<select name="klasse">
					...
					<p>Hvorn&aring;r begyndte du p&aring; skolen?<br>
						<select name="year">
					...
					<p>1. Jeg arbejder bedst alene:<br>
						...
						<input type="radio" name="Q1" value="10">10&nbsp;</p><br>

					<p>2. Jeg synes, tavlenoterne er det vigtigste udbytte fra timerne:<br>
                                                ...
                                                <input type="radio" name="Q2" value="10">10&nbsp;</p><br>

					<p>3. Det er vigtigt for mig, at undervisningen rammer mine personlige interesser:<br>
						<input type="radio" name="Q3" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q3" value="10">10&nbsp;</p><br>

					<p>4. For mig er det faglige vigtigere end det sociale i gymnasiet:<br>
						<input type="radio" name="Q4" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q4" value="10">10&nbsp;</p><br>
					
					<p>5. F&aelig;llestimer og aktiviteter p&aring; tv&aelig;rs af klasserne er 
						meget vigtige for mig:<br>
						<input type="radio" name="Q5" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q5" value="10">10&nbsp;</p><br>
				
					<p>6. Det, at vi har det godt sammen i klassem har stor betydning for mit faglige udbytte:<br>
						<input type="radio" name="Q6" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q6" value="10">10&nbsp;</p><br>

					<p>7. De venner, jeg har på gymnasiet, er afgørende for, at jeg kommer skole:<br>
						<input type="radio" name="Q7" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q7" value="10">10&nbsp;</p><br>

					<p>8. Jeg forbereder mig meget ofte sammen med andre:<br>
						<input type="radio" name="Q8" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q8" value="10">10&nbsp;</p><br>

					<p>9. Jeg synes, jeg svigter mine kammerater, hvis jeg er dårligt forberedt til timerne:<br>
						<input type="radio" name="Q9" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q9" value="10">10&nbsp;</p><br>

					<p>10. Jeg er selv ansvarlig for, hvor meget jeg f&aring;r ud af undervisningen:<br>
						<input type="radio" name="Q10" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q10" value="10">10&nbsp;</p><br>

					<p>11. Jeg kan kun arbejde sammen med nogen p&aring; mit eget faglige niveau:<br>
						<input type="radio" name="Q11" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q11" value="6">6&nbsp;
                                                <input type="radio" name="Q11" value="7">7&nbsp;
                                                <input type="radio" name="Q11" value="8">8&nbsp;
                                                <input type="radio" name="Q11" value="9">9&nbsp;
                                                <input type="radio" name="Q11" value="10">10&nbsp;</p><br>

					<p>12. Det er meget vigtigt for mig, at hele klassen f&aring;r noget ud af undervisningen:<br>
						<input type="radio" name="Q12" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q12" value="6">6&nbsp;
                                                <input type="radio" name="Q12" value="7">7&nbsp;
                                                <input type="radio" name="Q12" value="8">8&nbsp;
                                                <input type="radio" name="Q12" value="9">9&nbsp;
                                                <input type="radio" name="Q12" value="10">10&nbsp;</p><br>

					<p>13. For mig er det vigtigt, at vi f&aring;r karakterer l&oslash;bende:<br>
						<input type="radio" name="Q13" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q13" value="6">6&nbsp;
                                                <input type="radio" name="Q13" value="7">7&nbsp;
                                                <input type="radio" name="Q13" value="8">8&nbsp;
                                                <input type="radio" name="Q13" value="9">9&nbsp;
                                                <input type="radio" name="Q13" value="10">10&nbsp;</p><br>

					<p>14. Jeg synes, det er godt med pr&oslash;ver, s&aring; jeg ved, hvor jeg ligger fagligt:<br>
						<input type="radio" name="Q14" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q14" value="6">6&nbsp;
                                                <input type="radio" name="Q14" value="7">7&nbsp;
                                                <input type="radio" name="Q14" value="8">8&nbsp;
                                                <input type="radio" name="Q14" value="9">9&nbsp;
                                                <input type="radio" name="Q14" value="10">10&nbsp;</p><br>

					<p>15. Det er meget vigtigt for mig, at jeg kan bruge det, jeg l&aelig;rer, i virkeligheden:<br>
						<input type="radio" name="Q15" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q15" value="6">6&nbsp;
                                                <input type="radio" name="Q15" value="7">7&nbsp;
                                                <input type="radio" name="Q15" value="8">8&nbsp;
                                                <input type="radio" name="Q15" value="9">9&nbsp;
                                                <input type="radio" name="Q15" value="10">10&nbsp;</p><br>

					<p>16. Jeg foretr&aelig;kker selvst&aelig;ndigt projektarbejde:<br>
						<input type="radio" name="Q16" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q16" value="6">6&nbsp;
                                                <input type="radio" name="Q16" value="7">7&nbsp;
                                                <input type="radio" name="Q16" value="8">8&nbsp;
                                                <input type="radio" name="Q16" value="9">9&nbsp;
                                                <input type="radio" name="Q16" value="10">10&nbsp;</p><br>

					<p>17. Jeg g&aring;r <em>kun</em> i gymnasiet for at komme ind p&aring; en bestemt uddannelse bagefter:<br>
						<input type="radio" name="Q17" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q17" value="6">6&nbsp;
                                                <input type="radio" name="Q17" value="7">7&nbsp;
                                                <input type="radio" name="Q17" value="8">8&nbsp;
                                                <input type="radio" name="Q17" value="9">9&nbsp;
                                                <input type="radio" name="Q17" value="10">10&nbsp;</p><br>

					<p>18. Det er vigtigt for mig at vide pr&aelig;cis, hvad det, vi laver, skal bruges til:<br>
						<input type="radio" name="Q18" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q18" value="6">6&nbsp;
                                                <input type="radio" name="Q18" value="7">7&nbsp;
                                                <input type="radio" name="Q18" value="8">8&nbsp;
                                                <input type="radio" name="Q18" value="9">9&nbsp;
                                                <input type="radio" name="Q18" value="10">10&nbsp;</p><br>

					<p>19. Jeg synes, det er rigtig sjovt at l&aelig;re noget nyt, ogs&aring; selvom jeg ikke lige ved, hvad jeg skal bruge det til:<br>
						<input type="radio" name="Q19" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q19" value="6">6&nbsp;
                                                <input type="radio" name="Q19" value="7">7&nbsp;
                                                <input type="radio" name="Q19" value="8">8&nbsp;
                                                <input type="radio" name="Q19" value="9">9&nbsp;
                                                <input type="radio" name="Q19" value="10">10&nbsp;</p><br>

					<p>20. Jeg kan lide at komme i dybden med stoffet:<br>
						<input type="radio" name="Q20" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q20" value="6">6&nbsp;
                                                <input type="radio" name="Q20" value="7">7&nbsp;
                                                <input type="radio" name="Q20" value="8">8&nbsp;
                                                <input type="radio" name="Q20" value="9">9&nbsp;
                                                <input type="radio" name="Q20" value="10">10&nbsp;</p><br>

					<p>21. Jeg kan godt li' at lave lektier, og jeg g&oslash;r det ikke kun for karakteren:<br>
						<input type="radio" name="Q21" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q21" value="6">6&nbsp;
                                                <input type="radio" name="Q21" value="7">7&nbsp;
                                                <input type="radio" name="Q21" value="8">8&nbsp;
                                                <input type="radio" name="Q21" value="9">9&nbsp;
                                                <input type="radio" name="Q21" value="10">10&nbsp;</p><br>

					<p>22. Jeg synes, kommentarerne er vigtigere end karakteren i mine skriftlige opgaver:<br>
						<input type="radio" name="Q22" value="1">1&nbsp;
                                                ...
                                                <input type="radio" name="Q22" value="6">6&nbsp;
                                                <input type="radio" name="Q22" value="7">7&nbsp;
                                                <input type="radio" name="Q22" value="8">8&nbsp;
                                                <input type="radio" name="Q22" value="9">9&nbsp;
                                                <input type="radio" name="Q22" value="10">10&nbsp;</p><br>
